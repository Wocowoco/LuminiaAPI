...
export class AlchemistLayer extends MapLayerBase implements IAmMapLayer
{

  public imageUrl = this.worldmapImagePath + "icon/potion.png";
  ...
  //Icons
  private icon = L.icon({
    iconUrl: this.worldmapImagePath + "icon/potion.png",
    iconSize: [15,15],
    iconAnchor: [7.5, 7.5]
  });
